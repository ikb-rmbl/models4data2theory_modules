...
This is a tutorial on how to install the R language and RStudio development environment. This tutorial was modified from [here](https://github.com/rstudio/learnr/tree/main/inst/tutorials/ex-setup-r/ex-setup-r.Rmd).
