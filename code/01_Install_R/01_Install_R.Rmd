...
This is a tutorial on how to install the R language and RStudio development environment. This tutorial was modified from [here](https://github.com/rstudio/learnr/tree/main/inst/tutorials/ex-setup-r/ex-setup-r.Rmd) that made it.

### Outline

This tutorial will help you set up your computer to use R. It is for you if you need to learn how to:

* Install R on your computer
* Install the RStudio IDE
* Install packages, using the `dplyr` R package as an example.
...
question("Check all that you have NOT done:",
  ...
  answer("installed the dplyr R package", message = "* Install Packages"),
