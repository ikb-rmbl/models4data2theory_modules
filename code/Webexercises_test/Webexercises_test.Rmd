...
$$\frac{N_{t+1}-N_{t}}{\Delta t}=-kN_{t}$$

## Embed Google Slides (or other interactive content).

```{r, echo = FALSE}
knitr::include_url("https://docs.google.com/presentation/d/1zPgKsZVs7iksbRQ9EeteypKxy6h9bxRI0lgRlNwaW6k/edit?usp=sharing")
```